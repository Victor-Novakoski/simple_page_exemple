...
export default function BadgeCard({ user }: BadgeCardProps) {
  const { name, cpf, militaryId, vehicle } = user;
  return (
    <div className="w-80 bg-slate-900/90 backdrop-blur-sm rounded-lg shadow-2xl border border-green-700/30 p-6">
      ...
      <div className="space-y-2 text-sm text-gray-100">
        ...
        <p>
          <span className="font-semibold text-green-400">CPF:</span> {cpf}
        </p>
        <p>
          <span className="font-semibold text-green-400">ID Militar:</span> {militaryId}
        </p>
        <p>
